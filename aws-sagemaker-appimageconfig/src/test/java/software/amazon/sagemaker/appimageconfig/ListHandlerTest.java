...
public class ListHandlerTest extends software.amazon.sagemaker.appimageconfig.AbstractTestBase {

    private static final String OPERATION = "SageMaker::ListAppImageConfigs";
    ...
    public void testListHandler_SimpleSuccess() {
        final AppImageConfigDetails appImageConfig = AppImageConfigDetails.builder()
                .appImageConfigArn(TEST_APP_IMAGE_CONFIG_ARN)
                .appImageConfigName(TEST_APP_IMAGE_CONFIG_NAME)
                .build();

        final ListAppImageConfigsResponse listResponse = ListAppImageConfigsResponse.builder()
                .appImageConfigs(appImageConfig)
                .nextToken(TEST_TOKEN)
                .build();

        when(proxyClient.client().listAppImageConfigs(any(ListAppImageConfigsRequest.class)))
    ...
    @Test
    public void testListHandler_SimpleSuccess_NoAppImageConfigsExist() {
        final ListAppImageConfigsResponse listResponse = ListAppImageConfigsResponse.builder()
                .appImageConfigs(Collections.emptyList())
                .nextToken(null)
                .build();
