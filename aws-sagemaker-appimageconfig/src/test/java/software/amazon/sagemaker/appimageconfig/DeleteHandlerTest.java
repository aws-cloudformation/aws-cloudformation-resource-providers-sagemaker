...
public class DeleteHandlerTest extends software.amazon.sagemaker.appimageconfig.AbstractTestBase {
    ...
    public void testDeleteHandler_SimpleSuccess() {
        final DeleteAppImageConfigResponse deleteAppImageConfigResponse = DeleteAppImageConfigResponse.builder().build();

        final ResourceHandlerRequest<ResourceModel> request = ResourceHandlerRequest.<ResourceModel>builder()
                .desiredResourceState(getRequestResourceModel())
                .build();

        when(proxyClient.client().deleteAppImageConfig(any(DeleteAppImageConfigRequest.class)))
                .thenReturn(deleteAppImageConfigResponse);
