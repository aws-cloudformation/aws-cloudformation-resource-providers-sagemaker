...
public class ListHandler extends BaseHandlerStd {
    ...
    private static final String OPERATION = "AWS-SageMaker-Domain::List";
     ...
     */
    private ListDomainsResponse listResources(
            final ListDomainsRequest awsRequest,
            final ProxyClient<SageMakerClient> proxyClient) {

        ListDomainsResponse response = null;
        try {
            response =  proxyClient.injectCredentialsAndInvokeV2(awsRequest, proxyClient.client()::listDomains);
    ...
    private ProgressEvent<ResourceModel, CallbackContext> constructResourceModelFromResponse(
            final ListDomainsResponse listResponse) {
