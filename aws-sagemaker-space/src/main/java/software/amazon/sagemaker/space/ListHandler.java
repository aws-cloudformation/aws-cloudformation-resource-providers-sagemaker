...
public class ListHandler extends BaseHandlerStd {
    ...
    private static final String OPERATION = "AWS-SageMaker-Space::List";
     ...
     */
    private ListSpacesResponse listResources(
            final ListSpacesRequest awsRequest,
            final ProxyClient<SageMakerClient> proxyClient) {

        ListSpacesResponse response = null;
        try {
            response =  proxyClient.injectCredentialsAndInvokeV2(awsRequest, proxyClient.client()::listSpaces);
    ...
    private ProgressEvent<ResourceModel, CallbackContext> constructResourceModelFromResponse(
            final ListSpacesResponse listResponse) {
