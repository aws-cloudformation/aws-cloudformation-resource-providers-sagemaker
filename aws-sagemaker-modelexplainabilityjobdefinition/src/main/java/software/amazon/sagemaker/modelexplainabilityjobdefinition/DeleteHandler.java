...
public class DeleteHandler extends BaseHandlerStd {
    ...
    protected ProgressEvent<ResourceModel, CallbackContext> handleRequest(
        ...
        return ProgressEvent.progress(model, callbackContext)
                .then(progress ->
                        proxy.initiate("AWS-SageMaker-ModelExplainabilityJobDefinition::Delete", proxyClient, model, callbackContext)
     ...
     */
    private DeleteModelExplainabilityJobDefinitionResponse deleteResource(
            final DeleteModelExplainabilityJobDefinitionRequest awsRequest,
            final ProxyClient<SageMakerClient> proxyClient) {

        DeleteModelExplainabilityJobDefinitionResponse response = null;
        try {
            response = proxyClient.injectCredentialsAndInvokeV2(awsRequest, proxyClient.client()::deleteModelExplainabilityJobDefinition);
