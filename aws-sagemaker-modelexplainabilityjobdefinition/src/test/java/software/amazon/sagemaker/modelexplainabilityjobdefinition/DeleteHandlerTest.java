...
public class DeleteHandlerTest extends software.amazon.sagemaker.modelexplainabilityjobdefinition.AbstractTestBase {
    ...
    public void testDeleteHandler_SimpleSuccess() {
        final DeleteModelExplainabilityJobDefinitionResponse deleteModelExplainabilityJobDefinitionResponse = DeleteModelExplainabilityJobDefinitionResponse.builder()
                .build();
        ...
        when(proxyClient.client().deleteModelExplainabilityJobDefinition(any(DeleteModelExplainabilityJobDefinitionRequest.class)))
                .thenReturn(deleteModelExplainabilityJobDefinitionResponse);
    ...
    public void testDeleteHandler_WithoutJobDefinitionName_Success() {
        ...
        final ResourceHandlerRequest<ResourceModel> request = ResourceHandlerRequest.<ResourceModel>builder()
                ...
                .build();
        ArgumentCaptor<DeleteModelExplainabilityJobDefinitionRequest> requestCaptor = ArgumentCaptor.forClass(DeleteModelExplainabilityJobDefinitionRequest.class);
        ...
        verify(proxyClient.client(), times(1)).deleteModelExplainabilityJobDefinition(requestCaptor.capture());
    ...
    @Test
    public void testDeleteHandler_ModelExplainabilityJobDefinitionDoesNotExists_Fails() {
        when(proxyClient.client().deleteModelExplainabilityJobDefinition(any(DeleteModelExplainabilityJobDefinitionRequest.class)))
