...
public class AbstractTestBase {
    ...
    protected static final String TEST_SCHEDULE_ARN = "testScheduleArn";
    protected static final String TEST_SCHEDULE_NAME = "testScheduleName";
    ...
    protected static final String TEST_MONITORING_TYPE = "DataQuality";
