...
public class CreateHandlerTest extends software.amazon.sagemaker.modelqualityjobdefinition.AbstractTestBase {
    ...
    public void testCreateHandler_SimpleSuccess() {
        ...
        final CreateModelQualityJobDefinitionResponse createModelQualityJobDefinitionResponse = CreateModelQualityJobDefinitionResponse.builder()
                .jobDefinitionArn(TEST_JOB_DEFINITION_ARN)
                .build();
        ...
        when(proxyClient.client().createModelQualityJobDefinition(any(CreateModelQualityJobDefinitionRequest.class)))
                .thenReturn(createModelQualityJobDefinitionResponse);
    ...
    @Test
    public void testCreateHandler_ModelQualityJobDefinitionAlreadyExists_Fails() {
