...
public class ListHandler extends BaseHandlerStd {
    ...
    private static final String OPERATION = "AWS-SageMaker-App::List";
     ...
     * @return response ListAppsResponse
     */
    private ListAppsResponse listResources(
            final ListAppsRequest awsRequest,
            final ProxyClient<SageMakerClient> proxyClient) {

        ListAppsResponse response = null;
        try {
            response =  proxyClient.injectCredentialsAndInvokeV2(awsRequest, proxyClient.client()::listApps);
    ...
    private ProgressEvent<ResourceModel, CallbackContext> constructResourceModelFromResponse(
            final ListAppsResponse listResponse) {
