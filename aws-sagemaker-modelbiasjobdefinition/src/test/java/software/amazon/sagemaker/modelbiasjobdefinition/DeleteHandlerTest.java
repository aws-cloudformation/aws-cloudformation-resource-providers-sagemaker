...
public class DeleteHandlerTest extends software.amazon.sagemaker.modelbiasjobdefinition.AbstractTestBase {
    ...
    public void testDeleteHandler_SimpleSuccess() {
        final DeleteModelBiasJobDefinitionResponse deleteModelBiasJobDefinitionResponse = DeleteModelBiasJobDefinitionResponse.builder()
                .build();
        ...
        when(proxyClient.client().deleteModelBiasJobDefinition(any(DeleteModelBiasJobDefinitionRequest.class)))
                .thenReturn(deleteModelBiasJobDefinitionResponse);
    ...
    public void testDeleteHandler_WithoutJobDefinitionName_Success() {
        ...
        final ResourceHandlerRequest<ResourceModel> request = ResourceHandlerRequest.<ResourceModel>builder()
                ...
                .build();
        ArgumentCaptor<DeleteModelBiasJobDefinitionRequest> requestCaptor = ArgumentCaptor.forClass(
                DeleteModelBiasJobDefinitionRequest.class);
        ...
        verify(proxyClient.client(), times(1)).deleteModelBiasJobDefinition(requestCaptor.capture());
    ...
    @Test
    public void testDeleteHandler_ModelBiasJobDefinitionDoesNotExists_Fails() {
        when(proxyClient.client().deleteModelBiasJobDefinition(any(DeleteModelBiasJobDefinitionRequest.class)))
