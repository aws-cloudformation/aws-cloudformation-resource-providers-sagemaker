...
public class ListHandlerTest extends AbstractTestBase {
    ...
    public void testListHandler_SimpleSuccess() {
        final Image image = Image.builder()
                ...
                .build();
        final ListImagesResponse listImagesResponse = ListImagesResponse.builder()
                .images(image)
                .nextToken(TEST_TOKEN)
                .build();

        when(proxyClient.client().listImages(any(ListImagesRequest.class))).thenReturn(listImagesResponse);
    ...
    @Test
    public void testListHandler_NoImageExists() {
        final ListImagesResponse listImagesResponse = ListImagesResponse.builder()
                .images(Collections.emptyList())
                .nextToken(null)
                .build();

        when(proxyClient.client().listImages(any(ListImagesRequest.class)))
                .thenReturn(listImagesResponse);
